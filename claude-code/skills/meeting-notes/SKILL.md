...
| 문서 | 경로 | 용도 |
|------|------|------|
| 프로젝트 전체 구조 | `CLAUDE.md` | 모듈 목록, 도메인 약어 |
| 아키텍처 온보딩 | `bot/INDEX.md` 또는 `.local.claude/ONBOARDING.md` | 핵심 사용자 여정↔모듈 매핑, 이벤트 흐름 |
| 모듈 상세 분석 | `.local.claude/modules/{name}.md` | 개별 모듈 서비스, 테이블, 연동 |
...
**[사용자 개입 필요]** 회의 유형 (내부 vs 고객) 판단 모ho
